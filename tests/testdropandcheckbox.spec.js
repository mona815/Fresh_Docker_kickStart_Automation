...
const pageData = JSON.parse(fs.readFileSync(require.resolve('./data/pageData.json'), 'utf8'));
...
test('Select different text formats dynamically', async ({ page }) => {
  ...
  await page.fill('input[name="title[0][value]"]', pageData.title);
